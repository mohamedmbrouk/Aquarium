...
export default function News({ navigation }) {
    const handleLinkPress1 = () => {
        const url = 'https://www.dfo-mpo.gc.ca/oceans/conservation/plan/MCT-OCM-eng.html'; // Replace with your desired URL
        Linking.openURL(url)
      ...
      const handleLinkPress3 = () => {
        const url = 'https://open.canada.ca/data/dataset/a733fb88-ddaf-47f8-95bb-e107630e8e62'; // Replace with your desired URL
        Linking.openURL(url)
          .catch((err) => console.error('An error occurred', err));
      };
